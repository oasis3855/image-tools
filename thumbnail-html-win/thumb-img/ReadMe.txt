========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : SumbHtmlDir
========================================================================


AppWizard が生成した SumbHtmlDir には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには SumbHtmlDir を構成している各ファイルの概要説明が含まれています。
...
SumbHtmlDir.h
    ...
    みます） をインクルードし、また CSumbHtmlDirApp アプリケーションクラスを宣
    言します。

SumbHtmlDir.cpp
    このファイルは CSumbHtmlDirApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\SumbHtmlDir.ico
    ...
    ルです。このアイコンはリソース ファイル SumbHtmlDir.rc によってインクルード
    されます。
...
SumbHtmlDirDlg.h, SumbHtmlDirDlg.cpp - ダイアログ
    これらのファイルは CSumbHtmlDirDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な SumbHtmlDir.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) SumbHtmlDir.pch 
